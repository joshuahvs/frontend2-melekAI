...
export default function PricingPage() {
    ...
    return (
        <div style={{ backgroundColor: '#000000' }} className="text-white min-h-screen relative overflow-hidden font-sans">
            ...
            <header className="fixed w-full top-0 z-50 bg-black/20 backdrop-blur-xl border-b border-white/10 shadow-lg">
                <nav className="container mx-auto flex justify-between items-center py-5 px-6">
                    ...
                    <ul className="hidden md:flex gap-10 text-white/90 font-medium">
                        <li><Link href="/" className="hover:text-[#a529bb] transition-all duration-300">Beranda</Link></li>
                        <li><Link href="#pricing" className="text-[#a529bb] font-semibold">Pricing</Link></li>
                        <li><Link href="/solutions" className="hover:text-[#a529bb] transition-all duration-300">Solusi</Link></li>
                        <li><Link href="/contact" className="hover:text-[#a529bb] transition-all duration-300">Kontak</Link></li>
                    </ul>
                    <Link href="/login" className="bg-gradient-to-r from-[#a529bb] to-[#531e4c] text-white font-bold py-3 px-8 rounded-full shadow-xl hover:scale-105 transition-all duration-300 text-sm uppercase">
                        Masuk
                    </Link>
                </nav>
            </header>
            ...
            {/* Footer */}
            <footer className="relative bg-gradient-to-b from-black/30 to-black/80 backdrop-blur-xl border-t border-white/10">
                <div className="container mx-auto px-6 py-12">
                    <div className="text-center text-[#888994]">
                        <p>© 2025 MelekAI. All rights reserved. Dibuat dengan ❤️ di Indonesia</p>
                    </div>
                </div>
            </footer>
        </div>
